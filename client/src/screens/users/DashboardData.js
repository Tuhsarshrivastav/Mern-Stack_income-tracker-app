        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-6">
            <div class="p-8 border rounded-2">
              ...
              <h1 class="mb-4">{accountsDetails?.expenseStas[0].totalExp}</h1>
              <p class="mb-0">
                <span>Number of Transactions</span>
                <span class="text-danger ms-1">
                  <span>{accountsDetails?.expenseStas[0].totalRecordsExp}</span>
                </span>
              </p>
              ...
              <p class="mb-0">
                ...
                <span class="text-danger ms-1">
                  <span>{accountsDetails?.expenseStas[0].averageExp}</span>
                </span>
              </p>
            </div>
          </div>
          <div class="col-12 col-md-6 mb-6">
            <div class="p-8 border rounded-2">
              ...
              <h1 class="mb-4">{accountsDetails?.incomeStas[0].totalIncome}</h1>

              <p class="mb-0">
                <span>Number of Transactions</span>
                <span class="text-danger ms-1">
                  <span>{accountsDetails?.incomeStas[0].totalRecordsIncome}</span>
                </span>
              </p>
              ...
              <p class="mb-0">
                <span>Average Transactions</span>
                <span class="text-danger ms-1">
                  <span>{accountsDetails?.incomeStas[0].averageIncome}</span>
                </span>
              </p>
            </div>
          </div>
